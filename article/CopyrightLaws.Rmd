...
author:
- name: Niels Pepels
  affiliation: Max Planck Institute for European Legal History
  email: pepels@rg.mpg.de
- name: Andreas Wagner
  affiliation: Max Planck Institute for European Legal History
  email: wagner@rg.mpg.de
credits: 
- name: Kellen Funk
...
load("../cache/c-corpus-lsh.rda")
load("../cache/c-network-graphs.rda")
set.seed(82893)
